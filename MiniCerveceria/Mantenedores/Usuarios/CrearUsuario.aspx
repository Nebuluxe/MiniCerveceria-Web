<%@ Page Title="Mantenedores" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CrearUsuario.aspx.cs" Inherits="MiniCerveceria.Mantenedores.Usuarios.CrearUsuario" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
	...
	<nav id="barraNav" class="navbar bg-body-tertiary">
	  <div class="container-fluid">
			<a runat="server" href="~/Mantenedores/Usuarios/DefaultUsuarios.aspx"> 
				<img id="imgButtonBack" src="/Imagenes/Iconos/BackButtonWithe.png" height="40"> 
			</a>
			<strong class="titulo" style="font-size:1.9em; color: #ffffff;"><img src="/Imagenes/Iconos/UsuariosWithe.png" height="40" width="40"><span> </span><asp:Label runat="server" ClientIDMode="Static" id="CambioNomVentana"></asp:Label> Usuarios</strong>
		  	<a href="#"> 
