<%@ Page Title="Mantenedores" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="VerUsuario.aspx.cs" Inherits="MiniCerveceria.Mantenedores.Usuarios.VerUsuario" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <nav id="barraNav" class="navbar bg-body-tertiary">
	  <div class="container-fluid">
			...
			<strong class="titulo" style="font-size:1.9em; color: #ffffff;"><img src="/Imagenes/Iconos/UsuariosWithe.png" height="40" width="40"><span> </span> Ver Usuarios</strong>
			<span> </span>
	  </div>
	</nav>
	<br />
