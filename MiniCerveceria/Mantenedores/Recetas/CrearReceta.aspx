<%@ Page Title="Mantenedores" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CrearReceta.aspx.cs" Inherits="MiniCerveceria.Mantenedores.Recetas.CrearReceta" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
	...
	<nav id="barraNav" class="navbar bg-body-tertiary">
	  <div class="container-fluid">
			<a runat="server" href="~/Mantenedores/Recetas/DefaultRecetas.aspx"> 
				<img id="imgButtonBack" src="/Imagenes/Iconos/BackButtonWithe.png" height="40"> 
			</a>
			<strong class="titulo" style="font-size:1.9em; color: #ffffff;"><img src="/Imagenes/Iconos/RecetasWithe.png" height="40" width="40"><span> </span><asp:Label runat="server" ClientIDMode="Static" id="CambioNomVentana"></asp:Label> Recetas</strong>
		  	<a href="#"> 
