    ...
    <nav id="barraNav" class="navbar bg-body-tertiary">
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-10">
                    <asp:Label CssClass="titulo" Style="font-size: 1.9em; color: #ffffff;" runat="server" ClientIDMode="Static">Ver curso</asp:Label>
                </div>
            </div>
			<span>
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-8">
                            ...
                            <div class="row mb-1">
                                <asp:textbox style="min-width: 100%; height:250px;" runat="server" ClientIDMode="Static" TextMode="MultiLine" class="form-control" id="txtDescripcion" rows="3" readonly="true"/>
