	...
	<nav id="barraNav" class="navbar bg-body-tertiary">
	  <div class="container-fluid">
			...
			<strong class="titulo" style="font-size:1.9em; color: #ffffff;"><img src="/Imagenes/Iconos/NovedadesWithe.png" height="40" width="40"><span> </span> Novedades</strong>
		  	<a runat="server" href="~/Mantenedores/Novedades/CrearNovedades.aspx"> 
				  ...
				  <div >
					...
					<div  align="center">
						...
						<div class="btn-group" role="group" >
						  <a type="button" class="btn btn-outline-light" runat="server" href="~/Mantenedores/Novedades/CrearNovedades.aspx?uid=ItemPrueba1">Editar</a>
						  <a type="button" class="btn btn-outline-light" runat="server" href="~/Mantenedores/Novedades/VerNovedades.aspx?uid=ItemPrueba1">Ver</a>
